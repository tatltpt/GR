...
class AddActionModal extends Component {
    ...
    handleSubmit = async () => {
        ...
        if (beforeAfter === '前') {
            if (hourDay === '時間') {
                if (time >=10) {
                    finalTime = 'cc' + finalTime;
                }
                else finalTime = 'c' + finalTime;
            } else if (hourDay === '⽇') {
                if (time >=10) {
                    finalTime = 'dd' + finalTime;
                }
                else finalTime = 'd' + finalTime;
            }
            ...
            if (hourDay === '時間') {
                ...
                else finalTime = 'cc' + finalTime;
            } else if (hourDay === '⽇') {
                if (time >=10) {
                    finalTime = 'd' + finalTime;
                }
                else finalTime = 'dd' + finalTime;
            }
